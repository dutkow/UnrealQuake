...
qboolean trap_InPVS( const vec3_t p1, const vec3_t p2 ) {
	...
	return syscall( G_IN_PVS, p1, p2 ) != 0 ? qtrue : qfalse; // UnrealQuake: Updated to correct qboolean return type
}

qboolean trap_InPVSIgnorePortals( const vec3_t p1, const vec3_t p2 ) {
	//return syscall( G_IN_PVS_IGNORE_PORTALS, p1, p2 );
	return syscall(G_IN_PVS_IGNORE_PORTALS, p1, p2) != 0 ? qtrue : qfalse; // UnrealQuake: Updated to correct qboolean return type
}
...
qboolean trap_AreasConnected( int area1, int area2 ) {
	...
	return syscall(G_AREAS_CONNECTED, area1, area2) != 0 ? qtrue : qfalse; // UnrealQuake: Updated to correct qboolean return type
}
...
qboolean trap_EntityContact( const vec3_t mins, const vec3_t maxs, const gentity_t *ent ) {
	...
	return syscall(G_ENTITY_CONTACT, mins, maxs, ent) != 0 ? qtrue : qfalse; // UnrealQuake: Updated to correct qboolean return type
}

qboolean trap_EntityContactCapsule( const vec3_t mins, const vec3_t maxs, const gentity_t *ent ) {
	//return syscall( G_ENTITY_CONTACTCAPSULE, mins, maxs, ent );
	return syscall( G_ENTITY_CONTACTCAPSULE, mins, maxs, ent ) != 0 ? qtrue : qfalse; // UnrealQuake: Updated to correct qboolean return type
}
...
qboolean trap_GetEntityToken( char *buffer, int bufferSize ) {
	...
	return syscall(G_GET_ENTITY_TOKEN, buffer, bufferSize) != 0 ? qtrue : qfalse;  // UnrealQuake: Updated to correct qboolean return type
}
